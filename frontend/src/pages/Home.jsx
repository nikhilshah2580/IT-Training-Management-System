...
const Home = () => {
  ...
  const bannerSlides = [
    {
      ...
      subtitle: "Build industry-ready skills with hands-on projects and expert mentorship.",
    ...
    },
    {
      ...
      subtitle: "Get 10% off on all professional certification and IT training programs.",
    ...
    },
    {
      ...
      subtitle: "Step into the world of AI, automation, and data analytics today.",
      badge: "What's New",
  ...
  const handleSearch = (e) => {
    e.preventDefault();
    navigate(`/courses?query=${encodeURIComponent(searchQuery)}&category=${selectedCategory}&level=${selectedLevel}`);
  };
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <section className="relative overflow-hidden text-white transition-all duration-500">
        <div className={`absolute inset-0 bg-linear-to-r ${bannerSlides[currentSlide].bg} transition-all duration-700`}></div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-20">
        <form onSubmit={handleSearch} className="bg-white rounded-2xl shadow-xl border border-gray-100 p-4 sm:p-6 grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
          ...
          {/* Skill Level Filter */}
          <div>
            <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">Skill Level</label>
            <select
              value={selectedLevel}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900">Core Services & Excellence</h2>
            <p className="mt-4 text-gray-600">Everything you need to accelerate your career in the technology sector.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="rounded-2xl border border-gray-100 bg-gray-50/50 p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">IT Training</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Practical, real-world instruction covering software development, web engineering, UI/UX, and cloud technologies.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50/50 p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-2">Certification Preparation</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
                Dedicated test prep and certification paths designed to validate your expertise with top industry standards.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-gray-100 bg-gray-50/50 p-8 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Customized training programs designed for corporate teams looking to upskill and adopt modern tech stacks.
              </p>
            </div>
          </div>
        </div>
