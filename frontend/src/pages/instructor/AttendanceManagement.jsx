...
const AttendanceManagement = () => {
  ...
  const attendanceRecords = readList(attendanceQuery.data, [
    "attendances",
    "attendance",
  ]);
      ...
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="mt-1 text-sm text-gray-500">
            Mark and update attendance for students in your courses.
          </p>
        </div>
        <button
          type="button"
        ...
        >
          <RefreshCw
            size={17}
            className={attendanceQuery.isFetching ? "animate-spin" : ""}
          />
          Refresh
        </button>
      </div>
      ...
      >
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-5">
          ...
          <select
            ...
            disabled={!courseId || enrollmentsQuery.isLoading}
            className="rounded-lg border px-3 py-2.5 disabled:bg-gray-50"
          >
            <option value="">
              {courseId ? "Select student" : "Select course first"}
            </option>
