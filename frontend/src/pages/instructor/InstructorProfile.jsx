...
const InstructorProfile = () => {
    ...
    if (isError) {
        const message = error?.response?.data?.message || "Instructor profile not found";
        ...
        return (
            <section className="rounded-lg border border-slate-200 bg-white p-8 text-center shadow-sm">
                ...
                <p className="mx-auto mt-2 max-w-xl text-sm leading-6 text-slate-500">
                    {message}. Add your bio, specialization, experience, and links so admins can review your profile.
                </p>
                <Link
    ...
    return (
        <div className="space-y-6">
            ...
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                <DetailItem icon={Briefcase} label="Designation" value={profile.designation} />
                <DetailItem icon={GraduationCap} label="Qualification" value={profile.qualification} />
                <DetailItem icon={Award} label="Specialization" value={profile.specialization} />
                <DetailItem icon={CheckCircle} label="Experience" value={`${profile.experience || 0} years`} />
            ...
            {(profile.linkedin || profile.github || profile.website) && (
                <section className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div className="mt-4 flex flex-wrap gap-3">
                        <SocialLink href={profile.linkedin} icon={LinkIcon} label="LinkedIn" />
