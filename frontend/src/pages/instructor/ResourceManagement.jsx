...
import { createResource, deleteResource, getResources, updateResource } from "../../api/resource.services";
...
const ResourceManagement = () => (
    <InstructorModulePage
        ...
        fields={[
            ...
            { name: "type", label: "Type", type: "select", required: true, options: ["video", "pdf", "document", "link", "image", "other"].map((value) => ({ value, label: value })) },
