    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Track your courses, assignments, attendance and learning progress.
        </p>
      </div>
        ...
        <div className="rounded-xl border bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 grid grid-cols-1 gap-3 sm:grid-cols-2">
            ...
            >
              ...
              <div>
                <p className="font-medium text-slate-800">Assignments</p>

                <p className="text-xs text-slate-500">View your assignments</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                ...
                <p className="text-xs text-slate-500">Check your attendance</p>
              </div>
            </button>
            ...
            >
              ...
              <div>
                <p className="font-medium text-slate-800">Certificates</p>
            ...
            <button
              type="button"
              onClick={() => navigate("/student/job-placements")}
              className="flex items-center gap-3 rounded-lg border p-4 text-left transition hover:border-blue-500 hover:bg-blue-50"
            >
              <Briefcase size={20} className="text-blue-600" />

              <div>
                <p className="font-medium text-slate-800">Job Placement</p>
            ...
            >
              ...
              <div>
                <p className="font-medium text-slate-800">Testimonials</p>
