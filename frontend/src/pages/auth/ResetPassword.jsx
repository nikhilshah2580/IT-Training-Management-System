...
import { resetPassword } from "../../api/auth.services";
...
const ResetPassword = () => {
    ...
    // If user navigated here directly without verification context, send them back
    useEffect(() => {
        if (!email || !otp) {
            showError("Unauthorized access. Please verify OTP first.", "Access Denied");
