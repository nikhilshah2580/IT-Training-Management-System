...
import { Mail, ShieldCheck, ArrowRight, Loader2, RefreshCw, ArrowLeft } from "lucide-react";
            ...
            <div className="relative w-full max-w-md rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-xl backdrop-blur-md sm:p-10 my-8">
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="mt-1.5 text-sm text-slate-500">
                        We've sent a verification code to <span className="font-semibold text-slate-700">{email || "your email"}</span>
                    </p>
                </div>
