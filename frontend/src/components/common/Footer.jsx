                ...
                <div className="grid gap-8 border-b border-gray-800 pb-8 md:grid-cols-2 lg:grid-cols-4">
                    <div className="space-y-3">
                        ...
                        <p className="max-w-sm text-sm leading-6 text-gray-400">
                            Practical IT training, career support, and software solutions for
                    ...
                    <div>
                        ...
                        <div className="space-y-2.5 text-sm text-gray-400">
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <a href="tel:9851344071" className="hover:text-white">
                                    9851344071
                                </a>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5">
                                ...
                                <a href="mailto:infotech@sipalaya.com" className="hover:text-white">
    ...
    <div>
        ...
        <ul className="space-y-2 text-sm">
            {links.map(([label, path]) => (
                <li key={path}>
                    <Link to={path} className="text-gray-400 transition-colors hover:text-white">
                        {label}
                    </Link>
                </li>
            ))}
...
const SocialLink = ({ href, label, children }) => (
    <a
        ...
        rel="noreferrer"
        aria-label={label}
        className="rounded-md bg-gray-800 p-2 text-gray-400 transition-colors hover:bg-gray-700 hover:text-white"
    >
